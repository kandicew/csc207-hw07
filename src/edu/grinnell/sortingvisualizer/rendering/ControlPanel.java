  ...
  public ControlPanel(NoteIndices notes, ArrayPanel panel) {
    ...
    playButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        Integer[] copied = notes.arr.clone();
        List<SortEvent<Integer>> sortevent =
            generateEvents((String) sorts.getSelectedItem(), copied);
        List<SortEvent<Integer>> comp = new ArrayList();
        List<SortEvent<Integer>> newsort = new ArrayList();
        for (SortEvent event : sortevent) {
